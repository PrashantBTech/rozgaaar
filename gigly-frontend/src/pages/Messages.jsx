  ...
  return (
    <div style={{ display:"flex", height:"calc(100vh - var(--header-h))", overflow:"hidden" }}>
      ...
      <div style={{
        ...
        <div style={{ overflowY:"auto", flex:1 }}>
          {loadingConvos ? (
            ...
            return (
              <div key={conv._id} onClick={() => setActive(conv)} style={{
      ...
      {!active ? (
        ...
        <div className={`messages-chat active`} style={{ flex:1, display:"flex", flexDirection:"column", overflow:"hidden", background:"var(--bg-base)" }}>

...
const API_BASE = process.env.REACT_APP_API_URL || "https://rozgaaar.onrender.com/api/v1";
...
export const paymentsAPI = {
  ...
  createOrder: (jobId) => api.post("/payments/create-order", { jobId }),
  verifyOrder: (data) => api.post("/payments/verify-order", data),
...
export const adminAPI = {
  ...
  featureJob: (id, isFeatured) => api.patch(`/admin/jobs/${id}/feature`, { isFeatured }),
